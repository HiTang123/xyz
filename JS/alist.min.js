	...
	drives.forEach(item => {
		...
		__drives[item.name] = {
			...
			getPic(data) {
				...
				return pic || (this.isFolder(data) ? "https://agit.ai/cacifer/xyz/raw/branch/master/wallpaper/icon/文件夹1.png" : "https://agit.ai/cacifer/xyz/raw/branch/master/wallpaper/icon/film1.png")
			},
	...
	if(path.endsWith("/")) {
		...
		if(isSearch && !isFile) {
			...
			let vod = {
				...
				vod_name: vod_title,
				type_name: "文件",
				vod_pic: "https://agit.ai/cacifer/xyz/raw/branch/master/wallpaper/icon/fangyingji1.png",
				vod_content: null,
				vod_play_from: drives.name,
