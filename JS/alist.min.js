	...
	drives.forEach(item => {
		...
		__drives[item.name] = {
			...
			getPic(data) {
				...
				return pic || (this.isFolder(data) ? "https://agit.ai/cacifer/xyz/raw/branch/master/wallpaper/icon/文件夹1.png" : "https://agit.ai/cacifer/xyz/raw/branch/master/wallpaper/icon/%e8%a7%86%e9%a2%91%20%e6%92%ad%e6%94%be%20%e5%bd%b1%e7%89%87%202.png")
			},
	...
	if(path.endsWith("/")) {
		...
		if(isSearch && !isFile) {
			...
			let vod = {
				...
				vod_name: vod_title,
				type_name: "文件",
				vod_pic: "https://agit.ai/cacifer/xyz/raw/branch/master/wallpaper/icon/die.gif",
				vod_content: null,
				vod_play_from: drives.name,
