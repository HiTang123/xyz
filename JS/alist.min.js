	...
	drives.forEach(item => {
		...
		__drives[item.name] = {
			...
			getPic(data) {
				...
				return pic || (this.isFolder(data) ? "https://agit.ai/cacifer/xyz/raw/branch/master/wallpaper/icon/文件夹1.png" : "https://agit.ai/cacifer/xyz/raw/branch/master/wallpaper/icon/15film.png")
			},
