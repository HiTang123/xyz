	...
	drives.forEach(item => {
		...
		__drives[item.name] = {
			...
			getPic(data) {
				...
				return pic || (this.isFolder(data) ? "https://ghproxy.com/https://raw.githubusercontent.com/HiTang123/xyz/master/wallpaper/icon/文件夹1.png" : "https://ghproxy.com/https://raw.githubusercontent.com/HiTang123/xyz/master/wallpaper/icon/film2.png")
			},
...
function getAll(otid, tid, drives, path) {
	try {
		...
		let vod = {
			...
			vod_name: vod_name,
			type_name: "文件夹",
			vod_pic: "https://ghproxy.com/https://raw.githubusercontent.com/HiTang123/xyz/master/wallpaper/icon/radio1.jpg",
			vod_content: tid,
			vod_tag: "folder",
	...
	if(!searchDriver || !wd) {
		...
		lists.forEach(it => {
			...
			vods.push({
				...
				vod_pic: "https://ghproxy.com/https://raw.githubusercontent.com/HiTang123/xyz/master/wallpaper/icon/fangying.png",
