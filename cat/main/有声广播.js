...
async function home(filter) {
  ...
  let filterObj = {
      ...
      "电台": [{"key":"tid","name":"分类","value":[{"n":"全部","v":""},{"n":"合集","v":"故事会合集"},,{"n":"睡前故事","v":"睡前故事合集"}{"n":"短篇鬼故事","v":"短篇恐怖灵异鬼故事"},{"n":"短篇小说","v":"有声短篇小说"}]},{"key": "order","name": "排序","value": [{ "n": "综合排序","v": "0"},{"n": "最多点击","v": "click"},{"n": "最新发布","v": "pubdate"},{"n": "最多弹幕","v": "dm"},{"n": "最多收藏","v": "stow"}]},{"key": "duration","name": "时长","value": [{"n": "全部","v": "0"},{"n": "60分钟以上","v": "4"},{"n": "30~60分钟","v": "3"},{"n": "10~30分钟","v": "2"},{"n": "10分钟以下","v": "1"}]}]
