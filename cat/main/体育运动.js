...
async function home(filter) {
  ...
  let filterObj = {
	...
	"武术教学": [{"key":"tid","name":"分类","value":[{"n":"全部","v":""},{"n":"拳击","v":"拳击"},{"n":"摔跤","v":"摔跤"},{"n":"散打","v":"散打"},{"n":"泰拳","v":"泰拳"},{"n":"咏春拳","v":"咏春拳"},{"n":"柔道","v":"柔道"},{"n":"跆拳道","v":"跆拳道"},{"n":"空手道","v":"空手道"},{"n":"截拳道","v":"截拳道"}]},{"key": "order","name": "排序","value": [{ "n": "综合排序","v": "0"},{"n": "最多点击","v": "click"},{"n": "最新发布","v": "pubdate"},{"n": "最多弹幕","v": "dm"},{"n": "最多收藏","v": "stow"}]},{"key": "duration","name": "时长","value": [{"n": "全部","v": "0"},{"n": "60分钟以上","v": "4"},{"n": "30~60分钟","v": "3"},{"n": "10~30分钟","v": "2"},{"n": "10分钟以下","v": "1"}]}],
